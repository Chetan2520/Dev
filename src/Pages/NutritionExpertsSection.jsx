    ...
    <div className="py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-semibold text-light-orange mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl border-2 border-light-orange p-8 text-center shadow-md hover:shadow-xl transition-shadow duration-300">
            <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-6">
              {/* <Users className="w-8 h-8 text-light-orange" /> */}
              <img src='/presentation.png' className='w-8 h-8' ></img>
            </div>
          ...
          <div className="bg-white rounded-xl border-2 border-light-orange p-8 text-center shadow-md hover:shadow-xl transition-shadow duration-300">
            <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <img src='/Workshops.png' className='w-8 h-8' ></img>
            </div>
            <h3 className="text-xl font-semibold text-gray-800 mb-4">
              Workshops & Webinars
            </h3>
          ...
          <div className="bg-white rounded-xl border-2 border-light-orange p-8 text-center hover:shadow-lg transition-shadow duration-300">
            <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <img src='/Planes.png' className='w-8 h-8' ></img>
            </div>
            <h3 className="text-xl font-semibold text-gray-800 mb-4">
              Tailored Wellness Plans
            </h3>
        ...
        <div className="bg-white rounded-xl border-2 border-light-orange p-8 mb-8 shadow-lg">
        ...
        {/* Coming Soon Section */}
        <div className="bg-white rounded-xl border-l-6 border-light-orange p-10 shadow-lg ">
          <h3 className="text-xl font-semibold text-gray-800 mb-4">
            Coming Soon!
          </h3>
